...
export default function InformationIcon () {
    return <>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#EAB308" height="35px" width="35px" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000">
